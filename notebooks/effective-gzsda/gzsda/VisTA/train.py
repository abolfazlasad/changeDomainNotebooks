...
def extend_cfg(cfg):
    """
    Add new config variables for VISTA.
    ...
    cfg.TRAIN.PER = 10
    cfg.TRAINER.VISTA = CN()
    cfg.TRAINER.VISTA.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.VISTA.DEBIASPL = True
    cfg.TRAINER.VISTA.GAMMA = 0.6
    cfg.TRAINER.VISTA.TAU = 0.5
    cfg.TRAINER.VISTA.L = 3
    cfg.TRAINER.VISTA.N = 10
    cfg.TRAINER.VISTA.M = 12
    cfg.TRAINER.VISTA.LAM_1 = 1.0
    cfg.TRAINER.VISTA.LAM_2 = 1.0
    cfg.TRAINER.VISTA.LAM_3 = 1.0
